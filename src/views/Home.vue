...
const posts = [
    { title: 'DLSEC-2025-1: 3X-UI Update Accepts Forged Server Certificates (CVE-2025-29331)', url: 'https://www.digilol.net/security-advisories/dlsec2025-001.html' },
    ...
    { title: 'Establishing persistence using extended attributes on Linux (featured on MITRE ATT&CK)', url: 'https://kernal.eu/posts/linux-xattr-persistence' },
...
<template>
                ...
                <div class="grid md:grid-cols-[1fr_300px] md:gap-24 gap-4">
                    <div>
                        ...
                        <ul class="list-inside list-['-_']">
                            <li class="mb-2 text-xl md:text-2xl">I system-administer a hacker community called <a
				    ...
				    class="italic underline" href="https://kernal.eu/~siren/cka.pdf">CKA</a>).
                            ...
                            <li class="mb-2 text-xl md:text-2xl">I program a lot in Go and Vue.js/TypeScript these days.</li>
                        </ul>
                    </div>
    ...
    <div id="projects" class="relative flex flex-row py-10 lg:px-48 justify-center items-center px-5 overflow-hidden">
        <div>
            ...
            <p class="text-xl md:text-2xl mb-10 text-center">Some projects where I am the sole maintainer or the main
                contributor.</p>

            <div class="grid md:grid-cols-2 gap-5">
		    <ProjectCard title="Plastik3D" link="https://plastik3d.net" img="plastik3d.webp" desc="A system for ordering 3D prints, with automatic print evaluation and cost estimation." :tags='["Go", "Vue.js"]' />
